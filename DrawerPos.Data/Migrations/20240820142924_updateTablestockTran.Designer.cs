...
namespace DrawerPos.Data.Migrations
{
    ...
    [Migration("20240820142924_updateTablestockTran")]
    partial class updateTablestockTran
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.Ingredient", b =>
                {
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.IngredientStock", b =>
                {
                    b.Property<int>("IngredientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.ProductIngredient", b =>
                {
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.TransactionDetail", b =>
                {
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.Unit", b =>
                {
                    b.Property<int>("UnitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.Ingredient", b =>
                {
                    b.HasOne("DrawerPos.Shared.Models.Unit", "Unit")
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.IngredientStock", b =>
                {
                    b.HasOne("DrawerPos.Shared.Models.Ingredient", "Ingredient")
                        .WithOne("IngredientStock")
                        .HasForeignKey("DrawerPos.Shared.Models.IngredientStock", "IngredientId")
            ...
            modelBuilder.Entity("DrawerPos.Shared.Models.TransactionDetail", b =>
                {
                    ...
                    b.HasOne("DrawerPos.Shared.Models.Transaction", "Transaction")
